        ...
        <h2 id ="heading_qt">{{ __('Book your favorite place on the map') }}</h2>
              <form action="" method="HEAD" id="datepickerform">
                ...
                @isset($maparray['err_msg2'])
                  <span id="errormsg_txt1" style="color:red;"> {{ __('You have to book for minimum') }} <?php if($maparray['set_admin']->day == "1") {echo "60";} if($maparray['set_admin']->day == "2") {echo "30";} if($maparray['set_admin']->day == "3") {echo "15";} ?> {{ __('day') }}.</span><br>
                @else
                  <span id="errormsg_txt1" class="text-primary"> {{ __('You have to book for minimum') }} <?php if($maparray['set_admin']->day == "1") {echo "60";} if($maparray['set_admin']->day == "2") {echo "30";} if($maparray['set_admin']->day == "3") {echo "15";} if($maparray['set_admin']->day == "4") {echo "1";} ?> {{ __('day') }}.</span><br>
                @endisset
                ...
                <span><strong>{{ __('Check-In') }} & {{ __('Check-Out') }}:</strong><span>
                      <div class="row">
                        <div class="col-sm-8 col-12">
                          ...
                          {{-- <input id="searchdate_numberofdays" min="0"  max='{{ $endday }}' type="number" name="no_of_day" placeholder="{{ __('Number of days') }}: 1"> --}}
                          @isset($maparray['err_msg'])
                            <span id="errormsg_txt" style="color:red;">{{ __('You have to book for minimum') }} <?php if($maparray['set_admin']->day == "1") {echo "60";} if($maparray['set_admin']->day == "2") {echo "30";} if($maparray['set_admin']->day == "3") {echo "15";} if($maparray['set_admin']->day == "4") {echo "1";} ?> {{ __('day') }}.</span><br>
                          @endisset
      ...
      <div class="col-sm-8 offset-sm-1">
        <h2 id ="heading_qt">{{ __('Book your favorite place on the map') }}</h2>
              <form action="" method="HEAD" id="datepickerform">
                ...
                {{-- <span><strong>{{ __('Arrival day') }}:</strong><span> --}}
                @isset($maparray['err_msg2'])
                  <span id="errormsg_txt1" style="color:red;"> {{ __('You have to book for minimum') }} <?php if($maparray['set_admin']->day == "1") {echo "60";} if($maparray['set_admin']->day == "2") {echo "30";} if($maparray['set_admin']->day == "3") {echo "15";} if($maparray['set_admin']->day == "4") {echo "1";}?> {{ __('day') }}.</span><br>
                @else
                  <span id="errormsg_txt1" class="text-primary"> {{ __('You have to book for minimum') }} <?php if($maparray['set_admin']->day == "1") {echo "60";} if($maparray['set_admin']->day == "2") {echo "30";} if($maparray['set_admin']->day == "3") {echo "15";} if($maparray['set_admin']->day == "4") {echo "1";} ?> {{ __('day') }}.</span><br>
                @endisset
